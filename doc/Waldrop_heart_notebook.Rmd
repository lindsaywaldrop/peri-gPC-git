...
branch.flowdata <- loadflowdata("branch","2020-12-09", dia, density)
branch.costdata <- NA
...
data <- list("racetrack" = racetrack.data, "obstacles" = obstacles.data, "branch" = branch.data, "branchandobstacles" = branchandobstacles.data)
